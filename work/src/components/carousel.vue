<template>
  ...
  >
    ...
    <button class="back iconfont icon-xiangzuo" v-show="isShow" @click="backMove(moveItem, moveWidth)">
    </button>
    <button class="next iconfont icon-xiangyou" v-show="isShow" @click="nextMove(moveItem, moveWidth)">
    </button>
